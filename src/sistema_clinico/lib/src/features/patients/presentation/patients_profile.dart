...
class PatientsProfile extends StatelessWidget {
  const PatientsProfile({required this.name, required this.avatar, super.key});
  final String name;
  final IconData avatar;

  @override
  Widget build(final BuildContext context) {
    final atendimentos = <Map<String, String>>[
      {
        'date': '04/11/2024',
        'description': 'Atividade de Concentração',
        'professional': 'Eduardo - Pediatra',
      },
      {
        'date': '06/12/2024',
        'description': 'Textura de alimentos',
        'professional': 'Rosa - Nutricionista',
      },
      {
        'date': '06/12/2024',
        'description': 'Jogo da memoria',
        'professional': 'Thiago - Educador',
      },
      {
        'date': '06/12/2024',
        'description': 'Atividade de Concentraçãs',
        'professional': 'Maria - Pediatra',
      },
      {
        'date': '06/12/2024',
        'description': 'Textura de alimentos',
